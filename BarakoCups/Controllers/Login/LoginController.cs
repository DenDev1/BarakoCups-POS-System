...
using BarakoCups.Models.PasswordReset;

namespace BarakoCups.Controllers.Login
{
    public class LoginController : Controller
    {
  
            private readonly BarakoCupsContext _context;
            private readonly PasswordService _passwordResetService; // Add this
            public LoginController(BarakoCupsContext context, PasswordService passwordResetService)
